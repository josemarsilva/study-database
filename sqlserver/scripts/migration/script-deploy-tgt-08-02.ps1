## ############################################################################
## filename: script-deploy-tgt-08-02.ps1
...
$sqlscriptfilename = "script-deploy-tgt-08-03.sql"
Set-Content -Path $sqlscriptfilename -Value "--"
Add-Content -Path $sqlscriptfilename -Value "-- script-deploy-tgt-08-03.sql: Dynamically generated by script-deploy-tgt-08-02.ps1"
...
foreach ($tsvFile in $a_tsvFiles) {
    ...
    # Iteration
    Write-Output "Importing '$($tsvFile.Item1)' object list from '$($tsvFile.Item2)' ..."
